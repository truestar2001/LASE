    ...
    def __init__(
        ...
        self.convs = nn.ModuleList(
            [
                ...
                weight_norm(Conv2d(512, 1024, (kernel_size, 1), 1, padding=(kernel_size // 2, 0))),
...
def average_generator_loss(loss_fn: nn.Module, disc_outputs: List[torch.Tensor]) -> torch.Tensor:
